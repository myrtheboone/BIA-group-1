# -*- coding: utf-8 -*-
"""
Created on Thu Feb 10 18:33:09 2022
...
#model_2a: Neural network without any hidden layers (the input layer connects directly to the output layer)
#
#
model = Sequential()
